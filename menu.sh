...
# Pedir una contraseña para abrir el script
echo -n "Ingrese la contraseña para abrir el script: "
read password
...
function show_passwords() {
  ...
  echo -e "\e[2m\e[32mContraseñas existentes:\e[0m"
  echo "$passwords"
}
...
function add_password() {
  ...
  echo -e "\e[2m\e[32mIngrese las nuevas contraseñas separadas por comas: \e[0m"
  read new_passwords
...
function add_user() {
  ...
  echo -e "\e[2m\e[32mIngrese el nombre del nuevo usuario: \e[0m"
  read new_user
  ...
  if echo "$existing_users" | grep -q "\<$new_user\>"; then
    echo -e "\e[2m\e[31mEl usuario ya existe. No se puede agregar.\e[0m"
    return
  fi
...
while true; do
  echo -e "\n\e[2m\e[31mMenú de opciones:\e[0m"
  echo -e "\e[2m\e[31m1. Mostrar contraseñas existentes\e[0m"
  echo -e "\e[2m\e[31m2. Agregar una contraseña\e[0m"
  echo -e "\e[2m\e[31m3. Eliminar una contraseña\e[0m"
  echo -e "\e[2m\e[31m4. Agregar un nuevo usuario\e[0m"
  echo -e "\e[2m\e[31m5. Salir\e[0m"
  ...
  case $option in
    ...
    4) add_user;;
    5) exit;;
    *) echo -e "\e[2m\e[31mOpción inválida.\e[0m";;
  esac
done
